...
class GotoSuperActionSplit : PresentableActionHandlerBasedAction(), CodeInsightActionHandler, DumbAware {
    ...
    override fun update(event: AnActionEvent) {
        LOG.debug { "GotoSuperActionSplit - update(event: AnActionEvent)" }
...
//        }
//
//        val activeLookup: Lookup? = LookupManager.getInstance(project).getActiveLookup()
...
//            }
//
//            update(presentation, project, editor, psiFile, dataContext, event.isFromContextMenu)
//        }
