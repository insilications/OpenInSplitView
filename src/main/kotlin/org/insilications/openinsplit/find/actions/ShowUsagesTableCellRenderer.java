...
final class ShowUsagesTableCellRenderer implements TableCellRenderer {
    ...
    ShowUsagesTableCellRenderer(@NotNull Predicate<? super Usage> originUsageCheck, @NotNull AtomicInteger outOfScopeUsages, @NotNull SearchScope searchScope) {
    ...
    @DirtyUI
    @Override
    public Component getTableCellRendererComponent(JTable list, Object value, boolean isSelected, boolean hasFocus, int row, @UsageTableColumn int column) {
    ...
    private static void appendGroupText(@NotNull JTable table, final GroupNode node, @NotNull JPanel panel, Color fileBgColor, boolean isSelected) {
